...
class MotionStitch:
    ...
    def setup(
        ...
        print(f"[AIIA Debug] MotionStitch Setup: v1.9.400. LATEST VERSION LOADED.")
    ...
    def __call__(self, x_s_info, x_d_info, **kwargs):
        ...
        if "delta_mouth" in kwargs:
             ...
             # [v1.9.511] DISABLED DIAGNOSTIC: Isolate "Drifting" source.
        ...
        # [v1.9.512] DISABLED: Redundant with upstream Hard Lock. Potential interference.
