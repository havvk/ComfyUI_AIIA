...
class AIIA_CosyVoice_TTS:
    ...
    def INPUT_TYPES(cls):
        return {
            "required": {
                "model": ("COSYVOICE_MODEL",),
                "prompt_label_1": ("STRING", {"default": "📖 第一步：在此输入您想让 AI 说的话 (TTS Text)", "is_label": True}),
                "tts_text": ("STRING", {"multiline": True, "default": "你好，这是 CosyVoice 3.0 的全能模式测试。"}),
                "prompt_label_2": ("STRING", {"default": "🎨 第二步：在此输入对表现力/情感的文字描述 (Style Description)", "is_label": True}),
